...
class Traveller_Agency_Loader {
	 ...
	 * @return void
	 */
	public function traveller_agency_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function traveller_agency_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function traveller_agency_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function traveller_agency_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->traveller_agency_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function traveller_agency_load( $class ) {
